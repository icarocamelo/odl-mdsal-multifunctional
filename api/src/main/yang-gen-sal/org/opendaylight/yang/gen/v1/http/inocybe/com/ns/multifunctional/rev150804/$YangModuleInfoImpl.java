...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "multifunctional";
    private final String namespace = "http://inocybe.com/ns/multifunctional";
    private final String revision = "2015-08-04";
    private final String resourcePath = "/META-INF/yang/multifunctional.yang";
